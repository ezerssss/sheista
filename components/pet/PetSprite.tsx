...
//  - grounded frames plant feet on rows 22-23 (toes on 23); airborne frames
//    tuck feet up around row 20 so the silhouette reads as flying
//  - keep the horizontal center of mass near x=11-12 so frame switches
//    within one action never jitter
//  - upright frames share the eye anchor (15,5); frames that move the head
...
// Passing step — body settles 1px, back leg planted, front foot lifted.
...
// Drive — neck stretched forward, back leg pushing, front leg reaching.
...
// Contact — front leg planted, back leg folded up behind.
...
// Sleeping loaf — legs tucked away, head sunk into the breast, eyes shut.
...
// Exhale — everything above the midline settles 1px lower.
...
// Airborne, wing spread flat — descending glide.
